...
class GuardrailedOptimizer:
    ...
    def __init__(
        self,
        run_id: str,
        librarian: OptimizerLibrarian = None,
        *,
        ...
        self.run_id = run_id
        self.lib = librarian or OptimizerLibrarian()
    ...
    def log_stage_start(self, stage_name: str, regime_id: str = ""):
        self.lib.log_stage_run(self.run_id, stage_name, "STARTED", regime_id=regime_id)

    def log_stage_complete(self, stage_name: str, regime_id: str = "", metrics: Dict = None):
        self.lib.log_stage_run(
            self.run_id,
            stage_name,
            "COMPLETED",
            regime_id=regime_id,
    ...
    def register_candidate(
        ...
        self.lib.upsert_candidate_library(
